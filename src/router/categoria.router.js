...
const {validaCategoria, validaIdParams, validaProdutosCarrinhoPedido} = require("../middleware/validacao.middleware");
...
router.post("/create", authMiddleware,validaProdutosCarrinhoPedido, validaCategoria,categoriaController.createCategoriaController);
